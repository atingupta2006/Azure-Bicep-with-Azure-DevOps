...
```text
https://biceplab-aug26.eastus.cloudapp.azure.com/
```
...
```text
https://logout:logout@biceplab-aug26.eastus.cloudapp.azure.com/logout
```

Then open https://biceplab-aug26.eastus.cloudapp.azure.com/ and sign in again (or Cancel).
...
Subscription name must be **MSDN**.
...
```text
buXX@biceplab-aug26.eastus.cloudapp.azure.com
```
...
```bash
ssh buXX@biceplab-aug26.eastus.cloudapp.azure.com
```
...
az login
az account show --query name -o tsv
az ssh vm -g rg-bicep-lab -n vm-bicep-lab
```

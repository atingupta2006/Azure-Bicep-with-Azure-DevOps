...
| Subscription | Class subscription on the board (confirm with `az account show`) |
| Region | `eastus` |
...
On a **laptop** (or Cloud Shell), sign in as `buXX@attt21.onmicrosoft.com`. Use the **class subscription on the board** (not Pay-As-You-Go for labs).
